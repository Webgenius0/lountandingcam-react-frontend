...
export default function HowItWorkJournaling() {
  return (
    <section className=" py-10  lg:py-30">
     ...
     <p className="text-center text-sm md:text-base lg:w-6/12 xl:w-4/12 w-11/12 mx-auto mb-12 text-gray-400">
        Each week, you’ll receive a new journaling prompt. Write your thoughts,
        save your entries, and revisit them anytime to see your personal growth.
      </p>
