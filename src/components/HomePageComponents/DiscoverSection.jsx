...
export default function DiscoverSection() {
  ...
  {/* box 01 Journaling */}
  <div className="hover:scale-95 hover:shadow-xl cursor-grab duration-300 ease-in-out 
  ...
  {/* img box */}
  <div className="hover:scale-95 hover:shadow-xl cursor-grab duration-300 ease-in-out rounded-xl 
  ...
  <div className="hover:scale-95 hover:shadow-xl cursor-grab duration-300 ease-in-out 
    ...
    <PaintSvg />
    <h4 className="text-2xl mt-8 mb-2 font-semibold">Creative Design</h4>
    <p className="text-gray-400 text-sm lg:text-base mb-8">
    ...
    <button className="text-primary flex gap-1 cursor-pointer group items-center hover:underline">
      ...
      <span className="group-hover:rotate-45 duration-300 ease-in-out">
        ...
        <div className="flex justify-center mt-6 lg:mt-12">
          <PrimaryBtn className="text-sm lg:text-base" text="Join Beaute Today" />
        </div>
      </div>
    </section>
  );
