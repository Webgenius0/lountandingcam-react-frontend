...
export default function Forgot() {
   ...
   return(
    <div className="bg-[#F7F5FB] rounded-xl w-full max-w-[450px] border  p-7 sm:p-10">
        ...
        <p className="text-gray-600 text-center mb-4">We'll help you reset it and access your content</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div
                ...
                className="link mt-3  flex justify-end cursor-pointer text-gray-600 gap-2  "
            >
               Remember password? <Link to='/auth/sign-in' >
               <span className='hover:underline text-primary'>Log In</span></Link>
            </div>
        </form>
